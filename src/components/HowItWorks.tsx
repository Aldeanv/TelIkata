...
const steps = [
  ...
  },
  {
    ...
    description:
      "Dapatkan penjelasan detail untuk setiap kesalahan yang ditemukan",
      ...
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        >
          ...
          <h2 className="text-3xl font-light text-gray-900 sm:text-4xl">
            Cara Kerja <span className="font-medium">TeliKata</span>
          </h2>
        </motion.div>
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="relative h-full bg-white rounded-xl p-8 border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300">
                <div
                  className={`w-12 h-12 rounded-lg mb-6 flex items-center justify-center bg-gradient-to-r ${step.accent}`}
                >
